...
import UserMenuDropdownComponent from "../page-components/user-menu-dropdown.component";
import SideBarMenuLinkComponent from "../page-components/sidebar-menu-link.component";
    ...
    return (
        <div className="menu">
            <div className="menu-header">
                <a href="index-2.html" className="menu-header-logo">
                    <img src="https://vetra.laborasyon.com/assets/images/logo.svg" alt="logo" />
                </a>
                <a href="index-2.html" className="btn btn-sm menu-close-btn">
            ...
            <div className="menu-body">
                ...
                <ul>
                    ...
                    <SideBarMenuLinkComponent
                        link="/admin"
                        classIcon="bi bi-bar-chart"
                        title="Dashboard"
                        status={location.pathname === '/admin'? 'active' : false}
                    />
                    <li>
                        <a href="#">
                    <span className="nav-link-icon">
                        <i className="bi bi-receipt"></i>
                            ...
                            <span>Orders <ArrowRight className="ml-4" /></span>
                        </a>
                        <ul>
                            <li>
                    ...
                    <span className="nav-link-icon">
                        <i className="bi bi-truck"></i>
                            ...
                            <span>Products  <ArrowRight className="ml-4" /></span>
                        </a>
                        <ul>
                            <li>
                    ...
                    <span className="nav-link-icon">
                        <i className="bi bi-wallet2"></i>
                            ...
                            <span>Buyer  <ArrowRight className="ml-4" /></span>
                        </a>
                        <ul>
                            <li>
                    ...
                    <span className="nav-link-icon">
                        <i className="bi bi-person-badge"></i>
                            ...
                            <span>Customers  <ArrowRight className="ml-4" /></span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                    <span className="nav-link-icon">
                        <i className="bi bi-receipt"></i>
                            ...
                            <span>Invoices  <ArrowRight className="ml-4" /></span>
                        </a>
                        <ul>
                            <li>
                    ...
                    <SideBarMenuLinkComponent link="/admin/settings" status={location.pathname === '/admin/settings'? 'active' : false} classIcon="bi bi-gear" title="Settings"/>
                    <li>
